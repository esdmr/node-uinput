...
declare class UInput {
    ...
    sendEvent (type: EventType, code: CodeType, value: number, syn?: boolean): Promise<void>;
    keyEvent (code: CodeType, press?: boolean): Promise<void>;
